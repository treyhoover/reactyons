...
import aspectRatio from "./modules/aspectRatio";
import backgroundPosition from "./modules/backgroundPosition";
import backgroundSize from "./modules/backgroundSize";
import borderColors from "./modules/borderColors";
import borderRadius from "./modules/borderRadius";
import borderStyle from "./modules/borderStyle";
import borderWidths from "./modules/borderWidths";
import borders from "./modules/borders";
import boxShadow from "./modules/boxShadow";
import clears from "./modules/clears";
import code from "./modules/code";
import coordinates from "./modules/coordinates";
import display from "./modules/display";
import flexbox from "./modules/flexbox";
import floats from "./modules/floats";
...
import heights from "./modules/heights";
import hovers from "./modules/hovers";
import letterSpacing from "./modules/letterSpacing";
import lineHeight from "./modules/lineHeight";
import links from "./modules/links";
import lists from "./modules/lists";
import maxWidths from "./modules/maxWidths";
import negativeMargins from "./modules/negativeMargins";
...
import skinsPseudo from "./modules/skinsPseudo";
import spacing from "./modules/spacing";
import tables from "./modules/tables";
import textAlign from "./modules/textAlign";
import textDecoration from "./modules/textDecoration";
import textTransform from "./modules/textTransform";
import typeScale from "./modules/typeScale";
import typography from "./modules/typography";
import utilities from "./modules/utilities";
import whiteSpace from "./modules/whiteSpace";
import widths from "./modules/widths";
import zIndex from "./modules/zIndex";

const allPropClasses = new Set([
  ...aspectRatio,
  ...backgroundPosition,
  ...backgroundSize,
  ...borderColors,
